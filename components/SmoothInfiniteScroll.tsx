...
const iconDataSets = {
  set1: [
    { emoji: '🍕', color: '#fef0eb' },  // Light orange tint
    { emoji: '🍔', color: '#e8eef7' },  // Light blue tint
    { emoji: '🍟', color: '#fcddd2' },  // Soft orange
    { emoji: '🌮', color: '#d1ddef' },  // Soft blue
    { emoji: '🍗', color: '#f9c9b8' },  // Medium orange tint
  ],
  set2: [
    { emoji: '🎮', color: '#e8eef7' },  // Light blue tint
    { emoji: '🎧', color: '#bacceb' },  // Medium blue tint
    { emoji: '☕', color: '#fef0eb' },  // Light orange tint
    { emoji: '🍿', color: '#fcddd2' },  // Soft orange
    { emoji: '🥤', color: '#d1ddef' },  // Soft blue
  ],
  set3: [
    ...
    { emoji: '🍪', color: '#fef0eb' },  // Light orange tint
    { emoji: '🎲', color: '#bacceb' },  // Medium blue tint
    { emoji: '🕹️', color: '#d1ddef' },  // Soft blue
  ],
};
