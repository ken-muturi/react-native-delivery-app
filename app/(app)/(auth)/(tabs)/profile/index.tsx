      ...
      >
        ...
        <View style={styles.section}>
          ...
          <View style={styles.sectionContent}>
            ...
            <SettingItem icon="car-outline" label="Vehicle Details" />
            <SettingItem icon="document-text-outline" label="Documents" />
            <SettingItem icon="wallet-outline" label="Earnings & Payouts" />
          </View>
        </View>
